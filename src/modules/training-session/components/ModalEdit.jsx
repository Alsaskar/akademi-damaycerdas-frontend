...
const ModalEditSession = ({ data, show, handleClose = () => { }, onSuccess = () => { } }) => {
    const { showToast, message, success, progress, show: showToastMessage, hide } = useToast();
    const { editSession } = useSessionTraining()
    ...
    const _handleSubmit = async (values, { setSubmitting, resetForm }) => {
        ...
        const res = await editSession(data.id, payload);
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Edit Sesi {data.order_number} - {data.judul}</Modal.Title>
                </Modal.Header>
                ...
                <Formik
                    initialValues={{
                        ...
                        attendance_open_before: data.attendance_open_before,
                        attendance_close_after: data.attendance_close_after,
