...
const ModalDeleteMember = ({ data, show, handleClose, onSuccess }) => {
    const { showToast, message, success, progress, show: showToastMessage, hide } = useToast()
    const { loading, removeMember } = useMember()
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} backdrop="static">
                ...
                <Modal.Header closeButton>
                    <Modal.Title>Hapus Member</Modal.Title>
                </Modal.Header>
                <Modal.Body>

                    <h5 align="center">Yakin ingin hapus {data?.firstname} {data?.lastname} ?</h5>
