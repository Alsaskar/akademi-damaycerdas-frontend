...
const ModalDeleteLibrary = ({ data, show, handleClose, onSuccess }) => {
    const { showToast, message, success, progress, show: showToastMessage, hide } = useToast()
    const { loading, removeLibrary } = useLibrary()

    const _handleDelete = async () => {
        const res = await removeLibrary(data.id)
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} backdrop="static">
                ...
                <Modal.Body>
                    ...
                    <h5 align="center">Yakin ingin hapus dokumen <u><i>{data?.title}</i></u> ?</h5>
                    <div align="center">Dokumen yang dihapus akan hilang dari sistem</div>
