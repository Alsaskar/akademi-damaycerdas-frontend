...
const ModalDeleteCategory = ({ data, show, handleClose, onSuccess }) => {
    const { showToast, message, success, progress, show: showToastMessage, hide } = useToast()
    const { loading, removeLibraryCategory } = useLibraryCategory()

    const _handleDelete = async () => {
        const res = await removeLibraryCategory(data.id)
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} backdrop="static">
                ...
                <Modal.Body>
                    ...
                    <h5 align="center">Yakin ingin hapus kategori <u><i>{data?.nama_kategori}</i></u> ?</h5>
                    <div align="center">Kategori yang dihapus akan hilang dari sistem</div>
